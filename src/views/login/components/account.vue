  ...
  setup() {
    ...
    const onSignIn = async () => {
      ...
      const userInfos = {
        ...
        photo: state.ruleForm.userName === 'admin' ? 'https://portrait.gitee.com/uploads/avatars/user/551/1654622_Sun125_1578956962.png!avatar200' : 'https://portrait.gitee.com/uploads/avatars/user/551/1654622_Sun125_1578956962.png!avatar200',
